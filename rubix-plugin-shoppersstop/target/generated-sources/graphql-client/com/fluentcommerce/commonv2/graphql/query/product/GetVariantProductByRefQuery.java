...
public final class GetVariantProductByRefQuery implements Query<GetVariantProductByRefQuery.Data, GetVariantProductByRefQuery.Data, GetVariantProductByRefQuery.Variables> {
  public static final String OPERATION_DEFINITION = "query GetVariantProductByRef($productRef: String!, $catalogueRef: String!) {\n"
  ...
  public GetVariantProductByRefQuery(@Nonnull String productRef, @Nonnull String catalogueRef) {
    Utils.checkNotNull(productRef, "productRef == null");
    Utils.checkNotNull(catalogueRef, "catalogueRef == null");
    variables = new GetVariantProductByRefQuery.Variables(productRef, catalogueRef);
  }

  @Override
  public String operationId() {
    return "8ce7d2c712445cb03ca80464974d855793ebd112058f80d5ed85419ea0a8abd4";
  }
  ...
  public static final class Builder {
    ...
    public GetVariantProductByRefQuery build() {
      Utils.checkNotNull(productRef, "productRef == null");
      Utils.checkNotNull(catalogueRef, "catalogueRef == null");
      return new GetVariantProductByRefQuery(productRef, catalogueRef);
    }
  }
  ...
  public static class VariantProduct {
    ...
    public VariantProduct(@Nonnull String __typename, @Nonnull String ref, @Nonnull String name,
        @Nullable String status, @Nonnull String type, @Nonnull String gtin,
    ...
    public ResponseFieldMarshaller marshaller() {
      return new ResponseFieldMarshaller() {
        ...
        public void marshal(ResponseWriter writer) {
          ...
          writer.writeString($responseFields[5], gtin);
    ...
    public static final class Mapper implements ResponseFieldMapper<VariantProduct> {
      ...
      public VariantProduct map(ResponseReader reader) {
        ...
        final String gtin = reader.readString($responseFields[5]);
        ...
        return new VariantProduct(__typename, ref, name, status, type, gtin, attributes);
      }
    }
