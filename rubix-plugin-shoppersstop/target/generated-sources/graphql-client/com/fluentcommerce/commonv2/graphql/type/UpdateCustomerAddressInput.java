...
public final class UpdateCustomerAddressInput {
  ...
  UpdateCustomerAddressInput(@Nonnull String id, Input<String> companyName, Input<String> name,
      Input<String> street, Input<String> city, Input<String> state, Input<String> postcode,
      Input<String> region, Input<String> country, Input<Double> latitude, Input<Double> longitude,
  ...
  public static final class Builder {
    ...
    public UpdateCustomerAddressInput build() {
      Utils.checkNotNull(id, "id == null");
      return new UpdateCustomerAddressInput(id, companyName, name, street, city, state, postcode, region, country, latitude, longitude, timeZone);
    }
  }
}
