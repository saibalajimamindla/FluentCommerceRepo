 ...
 */
@RuleInfo(
    name = "SelectRatedFulfilmentPlanFO",
...
@Slf4j
public class SelectRatedFulfilmentPlanFO extends BaseRule {

    private static final String CLASS_NAME = SelectRatedFulfilmentPlanFO.class.getSimpleName();
