 ...
 */
@RuleInfo(
    name = "FindProposedFulfilmentsFO",
...
@Slf4j
public class FindProposedFulfilmentsFO extends BaseRule {

    private static final String CLASS_NAME = FindProposedFulfilmentsFO.class.getSimpleName();
